  ...
  import { StyleSheet,Text,View,TextInput,TouchableHighlight,
  Button,KeyboardAvoidingView} from 'react-native';
  ...
  function Form({ address, balance, privateKey, withdraw }){
    ...
    errors,setError,setValue,
    formState,
    triggerValidation,
    getValues} = useForm({mode: "onChange", defaultValues: {
